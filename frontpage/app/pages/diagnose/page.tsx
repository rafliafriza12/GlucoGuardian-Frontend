        ...
        <div className=" mt-[15vh] w-full px-14 flex flex-col gap-36">
          ...
          <div className=" w-full flex flex-col items-center gap-28">
            ...
            <div
              data-aos={"fade-up"}
              data-aos-duration={"1000"}
              className=" w-full h-[450px] grid grid-cols-3 grid-rows-1 gap-20"
            >
              <div
                onMouseOver={() => {
                ...
                className={`w-full h-full bg-[#1B40FF] rounded-2xl relative duration-500 ${
                  isHover === 1
                    ? "-translate-y-10 shadow-[0px_40px_20px_grey]"
                    : "translate-y-0"
                }`}
              >
                <div
                  className={` ${
                    isHover !== 1 && isHover !== 0
                      ? "z-[2] backdrop-blur-[2px]"
                      : "z-[-1]"
                  } duration-300  w-full h-full  absolute rounded-2xl`}
                ></div>
                <div className=" w-full h-full gap-16 text-white flex flex-col items-center justify-start p-8">
                  ...
                  <p className="w-full text-center text-lg font-medium">
                    Measures blood sugar levels after an individual has not
                    eaten for at least 8 hours. It's used to detect diabetes and
                    prediabetes.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="w-full h-full gap-16 text-white flex flex-col items-center justify-start p-8">
                  ...
                  />
                  <p className="w-full text-center text-lg font-medium">
                    Checks blood sugar levels at any time, regardless of when
                    the last meal was consumed. It helps to diagnose diabetes if
                    the levels are consistently high.
                  </p>
                </div>
              </div>
              <div
            ...
            >
              <div className=" w-full flex flex-col justify-center items-start font-semibold pl-32">
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setBodyBecomesThin((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      bodyBecomesThin ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setBodyBecomesThin((state) => !state)}
                    className=" py-3 ms-2 font-semibold text-xl text-[#1B40FF] "
                  >
                    Body becomes thin
                  </h1>
                </div>
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setUrinatingALot((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      urinatingALot ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setUrinatingALot((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setThirstyEasily((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      thirstyEasily ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setThirstyEasily((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setTingling((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      tingling ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setTingling((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setBreakingBreath((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      breakingBreath ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setBreakingBreath((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setMore4kg((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      more4kg ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setMore4kg((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setDizziness((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      dizziness ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setDizziness((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setObstacles((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      obstacles ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setObstacles((state) => !state)}
                    className=" w-full py-3 ms-2 font-semibold text-xl text-[#1B40FF] "
                  >
                    Obstacles to the quality of husband and wife relationships
                    in men
                  </h1>
                </div>
              </div>
              ...
              <div className=" w-full flex flex-col items-start font-semibold pl-32">
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setCoughing((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      coughing ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setCoughing((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setPregnant((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      pregnant ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setPregnant((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setWeak((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      weak ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setWeak((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setBlurredVision((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      blurredVision ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setBlurredVision((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setVomiting((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      vomiting ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setVomiting((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setPale((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      pale ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setPale((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setNausea((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      nausea ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setNausea((state) => !state)}
                ...
                <div className="w-full flex justify-start items-center gap-2 cursor-pointer">
                  <div
                    onClick={() => setWounds((state) => !state)}
                    className={`w-[20px] h-[20px] border-[1px] border-gray-500 rounded-md ${
                      wounds ? "bg-[#1B40FF]" : "bg-white"
                    }`}
                  />
                  <h1
                    onClick={() => setWounds((state) => !state)}
          ...
          <div className=" w-full flex justify-center pb-24">
            <Link href={"/pages/diagnose/result"}

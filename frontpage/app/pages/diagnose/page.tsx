...
const Diagnose: React.FC = () => {
  ...
  const dataDiagnose: any = {
    fullName: name,
    age: age,
    date: date,
    gender: gender === "Male" ? true : false,
    diabetesHistory: diabetesHistory === "Yes" ? true : false,
    fastingBloodGlucose: fastingBlood,
    randomBloodSugarTest: randonSugarBlood,
    oralGlucose: oralGlucose,
    symptoms: {
      bodyBecomeThin: bodyBecomesThin,
      urinatingALot: urinatingALot,
      gettingThirstyEasily: thirstyEasily,
      tingling: tingling,
      breakingBreath: breakingBreath,
      moreFourKilo: more4kg,
      dizziness: dizziness,
      obstacles: obstacles,
      coughing: coughing,
      pregnant: pregnant,
